...
(function (global) {
  var SECTS = {
    yingchuan: {
      ...
      grievance: [
        { target: '太平道', type: '敌对', desc: '黄巾劫掠乡里，与义军势同水火，见则必战。' },
        { target: '西凉军', type: '戒备', desc: '凉州边军跋扈，日后或与董卓同流，需早做防备。' }
      ],
      quest: '剿匪安乡：累计讨平黄巾游散，传功长老授「颍川战法」，并提升义军声望。',
    ...
    taiping: {
      ...
      martials: ['太平咒（符箓奇术）', '吐纳术（内功根基）', '黄巾力士诀（蛮力外功）'],
      grievance: [
        { target: '颍川义军', type: '敌对', desc: '义军保境剿黄巾，两方相见分外眼红。' },
        { target: '十常侍 / 朝廷', type: '死仇', desc: '甲子年举事，与朝堂势不两立，遭四方围剿。' }
      ],
      quest: '甲子密谋：完成传道与聚义事件，授「太平咒」，并卷入黄巾主线抉择（侠义 / 凶名双轨在此分野）。',
