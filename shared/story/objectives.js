...
(function (global) {
  ...
  var QUEST_DEFS = {
    ...
    camp_farm: {
      ...
      // v20260920e：奖励加「水袋」——开垦薄田得了水袋，正好去农田水井打水浇畦 / 添槽（夜半添水）。
      reward: '干粮×1 · 水袋×1 · 修为+25 · 孙老好感+1'
    },
    ...
    water_cook: {
      ...
      hint: '农田那格的水井「打水」装满水袋 → 往伙房那格点「灶边水缸」倾进去，两趟。',
    ...
    night_water: {
      ...
      // v20260920e：水源改农田水井——打水装袋（水袋为开垦薄田所得），回囚室水槽「添水」注满。
      hint: '去农田那格的水井「打水」把水袋装满 → 回囚室那格的水槽点「添水」，把槽水注满——添满即了。',
