  ...
  TRIGGERS.push({
    ...
    steps: [
      ...
      { t: 'npcTalk', npc: 'zhoutingtao',
        prompt: '尘埃稍落，你才看清栅里那人：蓬头垢面，满身旧伤，眼神却清亮。他捋了捋乱发，拖长腔道：「某周听涛，天下间数一数二的相士——」忽又压低嗓子：「你这新来的，眼中被迷了尘，看不清人影，却瞒不过老夫的招子。」他屈指敲了敲栅栏：「你命数古怪，似一颗我看不透的变数。老夫替人窥命数，向来要些酬劳——你且去营中寻些吃食来，老夫便替你寻出一丝破解之法。这桩差事，你应是不应？」',
        asks: [
          { label: '〔应下〕好，我去寻些吃食来。',
            ...
            then: [ { t: 'acceptQuest', id: 'zt_food' }, { t: 'reveal', layer: 'dock', highlight: true } ] },
