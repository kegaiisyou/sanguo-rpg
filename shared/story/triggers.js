...
(function (global) {
  ...
  TRIGGERS.push({
    ...
    steps: [
      ...
      { t: 'sys', text: '〔顶部「状态栏」已点亮——「气血」是性命、「内力」使招式、「时辰」关系天色与遭遇。受伤时气血会变红，届时记得用药或歇脚。〕' },
      { t: 'npcTalk', npc: 'beggar_old',
        prompt: '老乞丐敲你脑壳：「先看清你自个光景——盯住上头『状态栏』。对了，你叫什么名儿？老夫总不能喊你「喂」。」',
        asks: [
          { label: '〔报名〕我叫{{name}}，敢问前辈尊号？', set: { favor: 1 },
            say: '老乞丐哈哈一笑：「名号？喊我老乞丐便罢。{{name}}，记下了——东北那头是猎棚，随我来，别落单。往后遇着人，也报得上名。」' },
          { label: '〔胡诌〕（随口报了个名。）',
