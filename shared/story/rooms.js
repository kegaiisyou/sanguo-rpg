...
(function (global) {
  var ROOMS = {
    ...
    ji_tongqu: {
      ...
      find: '细看：青石主道宽可并行六车，槐柳成荫旗幡招展；北去州牧府，东往大市商区，西向军营驻地。',
      npcs: ['shuoshu'],
      items: [],
      actions: []
    },
    ...
    ji_minli: {
      ...
      exits: { '西': 'ji_dashi' },
      find: '细看：土墙茅檐鳞次，井边妇人浣衣，孩童追逐嬉戏；巷口老槐下老卒闲坐说古，西行即回大市。',
      npcs: ['likui'],
      items: [],
      actions: []
    },
    ji_mashi: {
      ...
      exits: { '西': 'ji_guomen', '北': 'ji_heishan_zhai' },
      find: '细看：草场马群成群，乌桓马商议价声不绝；北面山影渐浓，隐约可见黑山寨旗——匪号震林，似有贼人出没。',
      npcs: ['wuhuan'],
      items: [],
      actions: [
    ...
    ji_heishan_zhai: {
      ...
      exits: { '南': 'ji_mashi', '北': 'ji_heishan_juyi' },
      npcs: ['heishan_zhai'],
