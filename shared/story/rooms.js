...
(function (global) {
  var ROOMS = {
    ...
    forest: {
      ...
      find: '细看：古木蔽日，小径荆棘丛生；林深处营寨火光隐约，时有呼喝之声——盗匪便盘踞于此。〔东〕巡山道（东）往林深去。',
      npcs: [],
      items: ['林间散落的五铢钱'],
      actions: [
    ...
    yanshan_jian: {
      ...
      npcs: [],
      find: '细看：山裂为涧，碎冰乱石壅塞，细流呜咽；人迹罕至，绝地也。东回山口，北去古栈道（出塞），涧底兽骨断戟昭示酷寒刀兵。',
      items: [],
      actions: []
    },
    yanshan_lindao: {
      ...
      npcs: ['yanshan_liehu'],
      find: '细看：密林蔽天，腐叶没膝，猎径屈曲向北通古栈道；兽蹄印与鲜卑弃物杂陈。南回山口；东北经深涧可通古栈道（出塞）。',
      items: [],
      actions: [
    ...
    yanshan_zhandao: {
      ...
      find: '细看：堑山堙谷旧道，乃北出塞外之古径；木栈朽蚀，石阶磨平。南接深涧（回山口），北向塞外——过此即非汉家疆界。',
      items: [],
      actions: [
    ...
    forest_patrol_a: {
      ...
      npcs: [], patrol: true,
      find: '细看：道旁歪斜的脚印杂沓，多是草鞋与马蹄；北侧林子更深，偶有黑影一闪。',
      items: [], actions: []
    },
    forest_patrol_b: {
      ...
      npcs: [], patrol: true,
      find: '细看：乱石后有新鲜的灰烬与啃剩的骨头，想是贼人临时歇脚处；南回巡山道（东），北面密林愈发幽暗。',
      items: [], actions: []
    },
    forest_patrol_c: {
      ...
      npcs: [], patrol: true,
      find: '细看：涧边草丛压得齐整，显是常有人上下；南侧回望来时的巡山道，此处已是尽头。',
      items: [], actions: []
    },
    ...
    ys_entrance: {
      ...
      npcs: ['beggar_old'],
      find: '细看：村口土墙塌处余烬未熄，老乞丐蹲在灶影里，浑浊眼里却精光一闪。〔北〕北巷寻老乞丐；〔东〕东溪桥；〔南〕南磨坊；〔西〕西柴院。',
      items: [], actions: []
    },
    ys_north: {
      ...
      find: '细看：巷口血迹拖出一串，往东猎棚方向去了；西去西北哨所，南回村口。',
      actions: []
    },
    ys_ne: {
    ...
    ys_east: {
      ...
      npcs: ['beggar_old'], items: [],
      find: '细看：桥面留着凌乱脚印与几点血迹；北回猎棚，南去田垄，西回村口。',
      actions: []
    },
    ys_se: {
