...
(function (global) {
  var ROOMS = {
    ...
    forest: {
      ...
      exits: { '西': 'camp', '东': 'forest_patrol_a', '南': 'build_test' },
    ...
    // ═══════════════════════════════════════════
    //  十三州州治所（v20260822as 按参考图补齐；空城占位，暂无 NPC，随主线逐步填充）
    // ═══════════════════════════════════════════
    ye: {
      id: 'ye', name: '邺城',
      desc: [
      ...
      items: [],
      actions: [
        { id: 'rest', label: '城中休整', group: '行动', tip: '寻一处馆驿安歇，气血内力尽复' }
      ]
    },
    changyi: {
      id: 'changyi', name: '昌邑',
