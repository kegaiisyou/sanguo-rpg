  ...
  var ROOMS = {
    ...
    yuyang_guomen: {
      ...
      desc: [
        ...
        '城外南望，洛阳大路烟尘隐隐；入郭门即进渔阳城。关吏正挨个验籍，墙根戍卒就着风沙啃着硬饼。'
      ],
      exits: { '北': 'yuyang_nanmen', '南': 'luoyang', '西': 'yuyang_xishijie', '东': 'yuyang_dongshijie' },
      npcs: ['yuyang_tingli'],
      find: '细看：郭门两侧揭帖写满入城税则与宵禁时刻，墙根戍卒就着风沙啃硬饼。南去洛阳大路尘土飞扬，北入城去便是南门；西首兵营旌旗隐约，东边市声渐起——渔阳便是个北疆门户的模样。',
      items: [],
      actions: [
    ...
    yuyang_tongqu: {
      ...
      desc: [
        ...
        '此乃全城枢纽：北抵北门通蓟城，南通南门郭门，东接东市街往商区，西通西市街向官署军营。'
      ],
      exits: { '南': 'yuyang_nanmen', '北': 'yuyang_beimen', '东': 'yuyang_dongshijie', '西': 'yuyang_xishijie' },
      npcs: ['yuyang_shuoshu'],
      find: '细看：青石主道车辙深陷，槐柳稀疏边风硬；北去北门通蓟城，南出郭门，东市街通大市，西市街达县衙与军营。',
      items: [],
      actions: []
    },
    yuyang_beimen: {
      ...
      desc: [
        ...
        '出得门来北望，官道蜿蜒直插蓟城方向；道旁偶见戍堡烽燧，遥接幽州戍守。'
      ],
      exits: { '南': 'yuyang_tongqu', '北': 'ji_guomen' },
      npcs: [], items: [],
      actions: [
    ...
    ji_guomen: {
      ...
      exits: { '北': 'ji_nanmen', '西': 'ji_liumin', '东': 'ji_mashi', '南': 'yuyang_beimen' },
      npcs: ['guanli'],
