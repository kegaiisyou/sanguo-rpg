...
(function(global){
  ...
  // ═══ 锚点 · 苦役营·牢房（单房间 + 六间子房，v20260910n）═══
    camp_prison: {
      id: 'camp_prison', name: '苦役营·牢房',
      desc: ['长巷两侧铁栅森然，风从栅缝钻过，带着潮气与远处草木腥。六间牢房分列东西——东侧天字一号至三号，西侧地字一号至三号，各关着形形色色的囚徒。',
             '你顺着栅廊望去，牢门皆虚掩或紧锁，囚徒们或坐或卧，目光却都朝着那几扇通往子牢房的门。'],
      exits: { '北': 'camp_tz1', '南': 'camp_tz2', '东': 'camp_tz3', '西': 'camp_dz1', '东北': 'camp_dz2', '西北': 'camp_dz3' },
      find: '牢区长巷铁栅森然，六间子牢房列于两侧。〔北〕天字一号〔南〕天字二号〔东〕天字三号〔西〕地字一号〔东北〕地字二号〔西北〕地字三号。',
      npcs: [], items: [],
      actions: [{ id: 'leave_prison', label: '回营区', tip: '退出牢房，回到苦役营囚室。' }]
    },
