...
(function (global) {
  ...
  LF.BUILD = {
    bp_yeolian: {
      ...
      interior: [
        { kind:'npc', name:'铁匠师傅', icon:'🧑‍🔧', desc:'围着皮围裙、抡锤如风的老师傅，通晓冶铁锻造。', acts:[
          { label:'请教冶炼', icon:'💬', fn:function(){ log('铁匠师傅瓮声道：「好铁要经千锤百炼——石中炼出铁锭，铁锭再锻成器物，不可急躁。」','sys'); openModal('building'); } },
          { label:'请他熔石', icon:'🔥', fn:function(){
        ...
        { kind:'obj', name:'冶炼炉膛', icon:'🔥', desc:'炉火正旺的冶炼炉，风箱呼呼作响。', acts:[
          { label:'熔石取铁', icon:'⚒️', fn:function(){
        ...
        { kind:'obj', name:'铁砧', icon:'🪨', desc:'沉重的铁砧，锤痕斑斑。', acts:[
          { label:'打造器具', icon:'🔨', fn:function(){ openModal('craft', {bench:'forge'}); } }
        ]}
      ]
    }
