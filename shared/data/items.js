(function (global) {
  ...
  var DEFS = {
    ...
    // —— 新增建筑图纸（v20260908）——
    tuzhi_blacksmith: { defId: 'tuzhi_blacksmith', name: '铁匠铺图', icon: '📜', cat: '图纸', blueprint: 'bp_blacksmith', price: 40,
      desc: '营造铁匠铺的图样。于背包「依图营造」置于房中，夯基立架、装炉设砧，铺成可炼铁锻兵、修理器具。' },
    tuzhi_tavern: { defId: 'tuzhi_tavern', name: '酒楼图', icon: '📜', cat: '图纸', blueprint: 'bp_tavern', price: 45,
      desc: '营造酒楼的图样。于背包「依图营造」置于房中，起楼造灶、置桌设柜，楼成可饮酒吃饭、打听消息。' },
    tuzhi_inn: { defId: 'tuzhi_inn', name: '客栈图', icon: '📜', cat: '图纸', blueprint: 'bp_inn', price: 35,
      desc: '营造客栈的图样。于背包「依图营造」置于房中，起房置床、设柜存物，栈成可住宿休息、寄存物品。' },
    tuzhi_martialhall: { defId: 'tuzhi_martialhall', name: '武馆图', icon: '📜', cat: '图纸', blueprint: 'bp_martialhall', price: 42,
      desc: '营造武馆的图样。于背包「依图营造」置于房中，立桩设架、列兵器，馆成可练武学艺、与人切磋。' },
    tuzhi_granary: { defId: 'tuzhi_granary', name: '粮仓图', icon: '📜', cat: '图纸', blueprint: 'bp_granary', price: 60,
      desc: '营造粮仓的图样。于背包「依图营造」置于房中，夯基筑囤、架梁苫顶，仓成可大量存储粮草。' },
    tuzhi_watchtower: { defId: 'tuzhi_watchtower', name: '瞭望塔图', icon: '📜', cat: '图纸', blueprint: 'bp_watchtower', price: 30,
      desc: '营造瞭望塔的图样。于背包「依图营造」置于房中，夯基立柱、搭台设梯，塔成可登高远眺、察敌观风。' },
    tuzhi_arrowtower: { defId: 'tuzhi_arrowtower', name: '箭塔图', icon: '📜', cat: '图纸', blueprint: 'bp_arrowtower', price: 38,
      desc: '营造箭塔的图样。于背包「依图营造」置于房中，夯基立柱、装弩设箭，塔成可自动射击来犯之敌。' },
    tuzhi_farmland: { defId: 'tuzhi_farmland', name: '农田图', icon: '📜', cat: '图纸', blueprint: 'bp_farmland', price: 25,
      desc: '营造农田的图样。于背包「依图营造」置于房中，整地修渠、围篱播种，田成可定时产出粮食。' },
    tuzhi_well: { defId: 'tuzhi_well', name: '水井图', icon: '📜', cat: '图纸', blueprint: 'bp_well', price: 20,
      desc: '营造水井的图样。于背包「依图营造」置于房中，挖井砌壁、置辘轳，井成可源源取水。' },
    tuzhi_pigpen: { defId: 'tuzhi_pigpen', name: '猪圈图', icon: '📜', cat: '图纸', blueprint: 'bp_pigpen', price: 18,
      desc: '营造猪圈的图样。于背包「依图营造」置于房中，整地围栅、置槽建窝，圈成可养猪产肉。' },
    tuzhi_gate: { defId: 'tuzhi_gate', name: '寨门图', icon: '📜', cat: '图纸', blueprint: 'bp_gate', price: 32,
      desc: '营造寨门的图样。于背包「依图营造」置于房中，夯基立门、置闸设岗，门成可为营地门户。' },
    tuzhi_training: { defId: 'tuzhi_training', name: '训练场图', icon: '📜', cat: '图纸', blueprint: 'bp_training', price: 28,
      desc: '营造训练场的图样。于背包「依图营造」置于房中，整地铺沙、设器立桩，场成可练武提升。' },
    // —— 冶炼工坊产出（铁料加工链）——
