...
*最后更新：2026-07-24（**巡检修复**：① 补全 15 个新增房间的 ROOM_OBJECTS（北门/西市街/东市街/练武场/郡衙/醉仙楼/茶肆/民居北·南巷/农田/小树林/荒地/森林/小山丘/荒山），此前这些房间无交互对象表，导致郡衙县令、醉仙楼掌柜、茶肆说书先生(已加的3个NPC)及出口按钮均不显示；② 地图放大按网格尺寸动态限幅，避免超过GPU纹理上限(4096)变空白；③ 修 map 监听泄漏(AbortController)，加双击复位到当前位置；历法/天候/NPC菜单/光和元年/清理测试实体/街道拓扑/正北太行 已完成）*
