...
| 设计项 | 状态 | 实际落地 | 代码落点 |
|--------|------|----------|----------|
| **P0 战斗系统** | ✅ 完成 | 半手动 + 伤害公式 `攻×100/(100+防)` + Buff/Debuff + 华雄 Boss；13 招 + 5 敌 + 4 AI | `shared/combat/engine.js`、`shared/data/martial.js`、`shared/data/enemies.js`、`index.html` 战斗 UI |
...
*最后更新：2026-08-17（补 §七：背包 v0.7/v0.8 重构清单、已修复 bug、玩法改进分析；§7.4 背包/腰带扩充、野外采药点、悟性接入与容量 bug 修复；§7.5 装备栏 2 列网格重排）*
