var global={LF:{ENEMIES:new Map(),MARTIAL_ARTS:{}}};
(function(global) {
  'use strict';
  ...
  // 伤害公式（百分比减伤模型，与 engine.js 同步）
  var DEF_DR_PER = 0.01;    // 每点防御战力提供 1% 减伤
  var DEF_DR_CAP = 0.80;    // 减伤率硬上限 80%（保留 20% 穿透）
  var DMG_SCALE  = 1.85;    // 攻击伤害放大系数
